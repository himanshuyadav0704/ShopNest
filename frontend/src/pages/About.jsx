...
const About = () => {
  ...
  return (
    <div style={containerStyle}>
      ...
      <h3 style={{ fontSize: '1.5rem', color: '#f97316', marginBottom: '15px' }}>Himanshu Yadav (@himanshu_yadav1074)</h3>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '10px', marginTop: '20px' }}>
        ...
        <a href="https://instagram.com/himanshu_yadav1074" target="_blank" rel="noreferrer" style={{ ...socialBtnStyle, background: 'rgba(236, 72, 153, 0.2)', borderColor: '#ec4899', color: '#ec4899' }}>📸 Instagram</a>
        <a href="https://www.linkedin.com/in/himanshuyadav0704" target="_blank" rel="noreferrer" style={{ ...socialBtnStyle, background: 'rgba(59, 130, 246, 0.2)', borderColor: '#3b82f6', color: '#3b82f6' }}>💼 LinkedIn</a>
        ...
        {/* <a href="https://x.com/himanshu_yadav1074" target="_blank" rel="noreferrer" style={socialBtnStyle}>✖️ X (Twitter)</a>
