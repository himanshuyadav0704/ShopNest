  ...
  useEffect(() => {
    ...
    const fetchStats = async () => {
      ...
      try {
        ...
        console.error(error);
        setError('Unable to fetch dashboard data. Please check your connection or login again.');
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '1000px', margin: '0 auto' }}>
      ...
      {loading ? (
        ...
        <div style={{ textAlign: 'center', margin: '50px 0', color: '#f87171' }}>{error}</div>
      ) : stats ? (
        ...
        <div style={{ textAlign: 'center', margin: '50px 0', color: '#f97316' }}>No data available.</div>
      )}
